...
class Candy_Dispenser:
  ...
  def __init__(self, window: Tk):
    ...
    self.spring_offset = 40  # Distance moved by spring
    ...
    Button(self.right_panel, text="Top", fg="white", bg=self.color_primary, font=("Arial", 14, "bold"),
           relief=RAISED,bd=7,command=self.top).place(x=52, y=200)
    
    Button(self.right_panel, text="Size", fg="white", bg=self.color_primary, font=("Arial", 14, "bold"),
